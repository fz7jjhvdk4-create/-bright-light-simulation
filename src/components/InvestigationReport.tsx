    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          ...
          innan ni kan gå vidare till implementeringsfasen.
        </p>
      </div>
      ...
      {isSubmitted ? (
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
          ...
          <p className="text-green-700">
            ...
            Invänta lärarens godkännande för att fortsätta till Fas 2.
          </p>
        </div>
      ) : (
        <div className="space-y-8">
            ...
            {actionProposals.length === 0 ? (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <p className="text-yellow-800 text-sm">
                  ...
                  Ni har inga åtgärdsförslag registrerade. Gå till verktyget "Åtgärdsförslag"
          ...
          <section>
            ...
            <textarea
              ...
              onBlur={saveReport}
              placeholder="Vilka rekommendationer har ni för nästa fas (implementeringen)? Vad bör prioriteras?"
          ...
          <div className="flex justify-end pt-4 border-t">
            <Button
              ...
              disabled={submitting || !summary || !methodology || rootCauses.length === 0 || actionProposals.length === 0}
