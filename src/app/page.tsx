  ...
  return (
    <main className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Project facts */}
        <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 sm:p-6 mb-6 sm:mb-10">
          <h3 className="text-lg sm:text-xl font-semibold text-yellow-800 dark:text-yellow-200 mb-3 sm:mb-4">
            Ert uppdrag
          </h3>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-2 sm:p-4 shadow-sm">
              <div className="text-lg sm:text-2xl font-bold text-yellow-600 dark:text-yellow-400">800 000</div>
              <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Budget (kr)</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-2 sm:p-4 shadow-sm">
              <div className="text-lg sm:text-2xl font-bold text-yellow-600 dark:text-yellow-400">6 mån</div>
              <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Deadline</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-2 sm:p-4 shadow-sm">
              <div className="text-lg sm:text-2xl font-bold text-yellow-600 dark:text-yellow-400">50%</div>
              <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Reduktionsmål</div>
            </div>
          </div>
        </div>

        {/* Login for existing groups */}
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 sm:p-6 shadow-sm mb-6">
          ...
          >
            <input
              ...
              className="flex-1 px-3 sm:px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 outline-none text-base uppercase"
              maxLength={6}
              pattern="[A-Za-z0-9]{6}"
              required
            />
